...
public class LiteraryActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_literary);
//		TextView literary_members = (TextView) findViewById(R.id.literary_members);
		TextView literary_head = (TextView) findViewById(R.id.literary_head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		literary_members.setTypeface(setFont);
		literary_head.setTypeface(setFont);
