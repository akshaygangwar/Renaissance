...
public class FineArtsActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_fine_arts);
//		TextView fine_arts_members = (TextView) findViewById(R.id.fine_arts_members);
		TextView fine_arts_head = (TextView) findViewById(R.id.fine_arts_head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		fine_arts_members.setTypeface(setFont);
		fine_arts_head.setTypeface(setFont);
