...
//		TextView music_members = (TextView) findViewById(R.id.music_members);
		TextView music_head = (TextView) findViewById(R.id.music_head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		music_members.setTypeface(setFont);
		music_head.setTypeface(setFont);
