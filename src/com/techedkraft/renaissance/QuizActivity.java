...
//		TextView quiz_members = (TextView) findViewById(R.id.quiz_members);
		TextView quiz_head = (TextView) findViewById(R.id.quiz_head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		quiz_members.setTypeface(setFont);
		quiz_head.setTypeface(setFont);
