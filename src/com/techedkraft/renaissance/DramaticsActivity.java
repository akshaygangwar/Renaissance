...
public class DramaticsActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_dramatics);
//		TextView dramatics_members = (TextView) findViewById(R.id.dramatics_members);
		TextView dramatics_head = (TextView) findViewById(R.id.dramatics_head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		dramatics_members.setTypeface(setFont);
		dramatics_head.setTypeface(setFont);
