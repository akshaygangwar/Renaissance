...
public class DanceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout newLayout = (LinearLayout) findViewById(R.id.linearLayout);
//		TextView dance_members = (TextView) findViewById(R.id.dance_members);
		TextView head = (TextView) findViewById(R.id.head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		dance_members.setTypeface(setFont);
		head.setTypeface(setFont);
