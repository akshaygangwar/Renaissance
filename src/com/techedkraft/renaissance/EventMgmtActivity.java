...
public class EventMgmtActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_event_mgmt);
//		TextView event_mgmt_members = (TextView) findViewById(R.id.event_mgmt_members);
		TextView event_mgmt_head = (TextView) findViewById(R.id.event_mgmt_head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		event_mgmt_members.setTypeface(setFont);
		event_mgmt_head.setTypeface(setFont);
