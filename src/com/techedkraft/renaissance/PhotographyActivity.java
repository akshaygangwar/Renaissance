...
//		TextView photography_members = (TextView) findViewById(R.id.photography_members);
		TextView photography_head = (TextView) findViewById(R.id.photography_head);
		Typeface setFont = Typeface.createFromAsset(getAssets(), "fonts/mvboli.ttf");
//		photography_members.setTypeface(setFont);
		photography_head.setTypeface(setFont);
